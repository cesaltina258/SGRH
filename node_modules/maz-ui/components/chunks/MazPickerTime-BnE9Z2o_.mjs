...
const Y = { class: "m-picker-time__column__items" }, Z = /* @__PURE__ */ W({
  ...
  setup(v, { emit: P }) {
    ...
    }, z = P, l = x(), m = x(), p = n(() => typeof o.value == "string" ? T(i(o.value).get("hour")) : void 0), A = n(
      ...
      async (e) => {
        ...
        if (e) {
          if (await h(), l.value) {
            ...
            ), u = r == null ? void 0 : r.offsetHeight, c = ((t = l.value) == null ? void 0 : t.offsetHeight) / 2 - u / 2;
            m.value = c / 16;
          }
          k(!1);
        }
    ...
    const k = (e) => {
      ...
      if (l.value) {
        ...
        m.value && r && u && l.value && (await h(), R(r, u, m.value * 16, t));
      }
    }, q = async (e, t) => {
      const r = i(o.value);
            ...
            [
              ...
              b("div", Y, [
                (d(!0), _(
                  w,
                  null,
                  M(r, ({ value: c, label: O, isDisabled: L }, F) => (d(), E(X, {
                    key: F,
                    size: "xs",
                    color: D(u, c) ? v.color : "transparent",
                    class: g({ "--is-selected": D(u, c) }),
                    disabled: L || v.disabled,
                    type: "button",
                    onClick: G((ee) => q(u, c), ["stop"])
                  }, {
                    default: J(() => [
                      K(
                        Q(O),
...
}), oe = /* @__PURE__ */ U(Z, [["__scopeId", "data-v-c85d4cb7"]]);
export {
  oe as default
};

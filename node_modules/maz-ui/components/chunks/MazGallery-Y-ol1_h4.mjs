...
var B = (o, e, t) => e in o ? H(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[e] = t;
...
import { _ as R } from "./MazCard-cwUZUG7s.mjs";
const U = `
.maz-zoom-img {
  position: fixed;
  top: 0;
...
const V = {
...
}, Z = { class: "m-gallery__wrapper maz-flex maz-flex-1" }, G = ["alt"], F = {
  key: 0,
  class: "m-gallery__remaining-layer maz-flex maz-bg-overlay maz-flex-center"
}, W = { class: "maz-text-2xl maz-text-white" }, Q = /* @__PURE__ */ S({
  __name: "MazGallery",
  props: {
    /**
  ...
  setup(o) {
    ...
    const e = M(() => import("./no-photography-5Lkm1tEM.mjs")), t = o;
    _(() => {
            ...
            C(c.value, (d, r) => (u(), g(
              ...
              [
                w(b("img", {
                  ...
                  [v(V), { src: d.thumbnail, disabled: !o.lazy }, "bg-image"],
                  [v(I), {
                    src: d.src,
                    alt: d.alt,
...
}), ee = /* @__PURE__ */ R(Q, [["__scopeId", "data-v-4e6fbc0c"]]);
export {
  ee as default
};

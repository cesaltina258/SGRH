...
import { _ as N } from "./MazDialogPromise-EK4I6H_i.mjs";
const P = /* @__PURE__ */ M({
  __name: "MazBtn",
  props: {
    variant: {
  ...
  setup(e) {
    const p = z(() => import("./MazSpinner-zkOGM_fo.mjs")), c = z(() => import("./MazIcon-RrJDzX3V.mjs")), { href: B, to: h } = E(), b = L(), n = e;
    R(() => {
...
}), j = /* @__PURE__ */ N(P, [["__scopeId", "data-v-3f2db58e"]]);
export {
  j as default
};

...
import { listViewHeaderStatus } from "@/components/baseTables/Status/listView/utils";
...
import RemoveItemConfirmationDialog from "@/components/baseTables/Status/listView/RemoveItemConfirmationDialog.vue";
      ...
      <v-row justify="space-between">
        ...
        <v-col lg="auto">
          <v-btn color="secondary" @click="onCreateEditClick(null)">
            <i class="ph-user-plus me-1" /> {{ $t('t-add-status') }}
          </v-btn>
        </v-col>
      </v-row>
    </v-card-title>

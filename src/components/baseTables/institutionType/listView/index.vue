...
import { listViewHeader } from "@/components/baseTables/institutionType/listView/utils";
import { agentListingData } from "@/components/baseTables/institutionType/utils";
import { AgentListingType } from "@/components/baseTables/institutionType/types";
      ...
      <v-row justify="space-between">
        ...
        <v-col lg="auto">
          <v-btn color="secondary" @click="onCreateEditClick(null)">
            <i class="ph-user-plus me-1" /> {{ $t('t-add-institution-type') }}
          </v-btn>
        </v-col>
      </v-row>
    </v-card-title>

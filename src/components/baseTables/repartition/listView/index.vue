...
import { listViewHeader } from "@/components/baseTables/repartition/listView/utils";
import { agentListingData } from "@/components/baseTables/repartition/utils";
import { AgentListingType } from "@/components/baseTables/repartition/types";
import Status from "@/app/common/components/Status.vue";
import TableAction from "@/app/common/components/TableAction.vue";
import CreateUpdateAgentDialog from "@/components/baseTables/repartition/CreateUpdateAgentDialog.vue";
import { formateDate } from "@/app/common/dateFormate";
import { useRouter } from "vue-router";
import RemoveItemConfirmationDialog from "@/components/baseTables/repartition/listView/RemoveItemConfirmationDialog.vue";
      ...
      <v-row justify="space-between">
        ...
        <v-col lg="auto">
          <v-btn color="secondary" @click="onCreateEditClick(null)">
            <i class="ph-user-plus me-1" /> {{ $t('t-add-repartition') }}
          </v-btn>
        </v-col>
      </v-row>
    </v-card-title>

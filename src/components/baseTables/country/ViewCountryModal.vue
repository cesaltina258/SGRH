      ...
      <v-card-text class="overflow-y-auto" :style="{
        ...
        <v-row>
          <v-col cols="12" lg="6">
            ...
            <TextField v-model="iso2Code" :placeholder="$t('t-enter-iso2-code')" disabled/>
          </v-col>
          <v-col cols="12" lg="6">
            <div class="font-weight-bold text-caption mb-1">
              {{ $t('t-iso3Code') }}
            </div>
            <TextField v-model="iso3Code" :placeholder="$t('t-enter-iso3-code')" disabled/>
          </v-col>
        </v-row>
        <v-row>
          <v-col cols="12" lg="6">
            ...
            <TextField v-model="phoneCode" :placeholder="$t('t-enter-phone-code')" disabled/>
          </v-col>
          <v-col cols="12" lg="6">
            <div class="font-weight-bold text-caption mb-1">
              {{ $t('t-currency') }}
            </div>
            <TextField v-model="currency" :placeholder="$t('t-enter-currency')" disabled/>
          </v-col>
        </v-row>
        <v-row>
          <v-col cols="12" lg="6">
            ...
            <TextField v-model="currencySymbol" :placeholder="$t('t-enter-currency-symbol')" disabled/>
          </v-col>
          <v-col cols="12" lg="6">
            <div class="font-weight-bold text-caption mb-1">
              {{ $t('t-currency-code') }}
            </div>
            <TextField v-model="currencyCode" :placeholder="$t('t-enter-currency-code')" disabled/>
          </v-col>
        </v-row>
      </v-card-text>
      <v-divider />

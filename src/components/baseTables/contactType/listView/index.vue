...
import { listViewHeader } from "@/components/baseTables/contactType/listView/utils";
import { agentListingData } from "@/components/baseTables/contactType/utils";
import { AgentListingType } from "@/components/baseTables/contactType/types";
import Status from "@/app/common/components/Status.vue";
import TableAction from "@/app/common/components/TableAction.vue";
import CreateUpdateAgentDialog from "@/components/baseTables/contactType/CreateUpdateAgentDialog.vue";
import { formateDate } from "@/app/common/dateFormate";
import { useRouter } from "vue-router";
import RemoveItemConfirmationDialog from "@/components/baseTables/contactType/listView/RemoveItemConfirmationDialog.vue";
  ...
  <v-card>
    <v-card-title class="mt-2 mb-2">
      <v-row justify="space-between">
        <v-col lg="3">
          <QuerySearch v-model="query" :placeholder="$t('t-search-contact-type')" />
        </v-col>
        <v-col lg="auto">
          <v-btn color="secondary" @click="onCreateEditClick(null)">
            <i class="ph-user-plus me-1" /> {{ $t('t-add-contact-type') }}
          </v-btn>
        </v-col>
      </v-row>
    </v-card-title>

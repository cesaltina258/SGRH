...
import { listViewHeader } from "@/components/baseTables/function/listView/utils";
import { agentListingData } from "@/components/baseTables/function/utils";
import { AgentListingType } from "@/components/baseTables/function/types";
import Status from "@/app/common/components/Status.vue";
import TableAction from "@/app/common/components/TableAction.vue";
import CreateUpdateAgentDialog from "@/components/baseTables/function/CreateUpdateAgentDialog.vue";
import { formateDate } from "@/app/common/dateFormate";
import { useRouter } from "vue-router";
import RemoveItemConfirmationDialog from "@/components/baseTables/function/listView/RemoveItemConfirmationDialog.vue";
      ...
      <v-row justify="space-between">
        ...
        <v-col lg="auto">
          <v-btn color="secondary" @click="onCreateEditClick(null)">
            <i class="ph-user-plus me-1" /> {{ $t('t-add-function') }}
          </v-btn>
        </v-col>
      </v-row>
    </v-card-title>

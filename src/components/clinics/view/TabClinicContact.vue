      ...
      <v-card-text class="pt-0">
        ...
        <v-row class="mt-2">
          <v-col cols="12" lg="6">
            <div class="font-weight-bold mb-2">
              {{ $t('t-income-tax-number') }} 
            </div>
            <div>{{ clinicData.incomeTaxNumber || '-' }}</div>
          </v-col>
          ...
          <v-col cols="12" lg="6">
            ...
            <div>{{ clinicData.personOfContactFullname1 || '-' }}</div>
          </v-col>
        </v-row>
        ...
        <v-row class="">
          <v-col cols="12" lg="6">
            ...
            <div>{{ clinicData.personOfContactPhone1 || '-' }}</div>
          </v-col>
          ...
          <v-col cols="12" lg="6">
            ...
            <div>{{ clinicData.personOfContactEmail1 || '-' }}</div>
          </v-col>
        </v-row>
        ...
        <v-row class="">
          <v-col cols="12" lg="6">
            ...
            <div>{{ clinicData.personOfContactFullname2 || '-' }}</div>
          </v-col>
          ...
          <v-col cols="12" lg="6">
            ...
            <div>{{ clinicData.personOfContactPhone2 || '-' }}</div>
          </v-col>
        </v-row>
        ...
        <v-row class="">
          <v-col cols="12">
            ...
            <div>{{ clinicData.personOfContactEmail2 || '-' }}</div>
          </v-col>
        </v-row>
      </v-card-text>

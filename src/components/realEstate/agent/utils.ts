import {
  ...
  import { MenuSelectItemTypeOption } from "@/app/common/components/filters/types";
  ...
  export const statusSelectOptions: MenuSelectItemTypeOption[] = [
    { label: "Select all", value: "" },
    { label: 'Sucesso', value: 'active' },
    { label: 'Atenção', value: 'unActive' },
    { label: 'Alerta', value: 'pending' },
  ]
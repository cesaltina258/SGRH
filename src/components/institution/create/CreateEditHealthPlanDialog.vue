          ...
          <v-row>
            <v-col cols="12" lg="6">
              ...
              <TextField v-model="childrenMaxAge" type="number" :rules="requiredRules.childrenMaxAge"
                :placeholder="$t('t-enter-children-max-age')" />
            </v-col>
            ...
            <v-col cols="12" lg="6">
              ...
              <TextField v-model="maxNumberOfDependents" type="number" :rules="requiredRules.maxNumberOfDependents"
                :placeholder="$t('t-enter-max-number-of-dependents')" />
            </v-col>
          </v-row>
          ...
          <v-row class="mt-n6">
            <v-col cols="12" lg="6">
              ...
              <MenuSelect v-model="healthPlanLimit" :items="healthPlanLimitOptions"
                :rules="requiredRules.healthPlanLimit" :placeholder="$t('t-select-health-plan-limit')" />
            </v-col>
            ...
            <v-col cols="12" lg="6">
              ...
              <TextField v-model="fixedAmount" type="number" :rules="requiredRules.fixedAmount"
                :placeholder="$t('t-enter-fixed-amount')" />
            </v-col>
          </v-row>
          ...
          <v-row class="mt-n6">
            <v-col cols="12" lg="6">
              ...
              <MenuSelect v-model="salaryComponent" :items="salaryComponentOptions"
                :rules="requiredRules.salaryComponent" :placeholder="$t('t-select-salary-component')" />
            </v-col>
            ...
            <v-col cols="12" lg="6">
              ...
              <TextField v-model="companyContributionPercentage" type="number"
                ...
                :placeholder="$t('t-enter-company-contribution-percentage')" />
            </v-col>
          </v-row>
          ...
          <v-row class="mt-n6">
            <v-col cols="12" lg="12">
              ...
              <MenuSelect v-model="coveragePeriod" :items="coveragePeriodOptions" item-title="name" item-value="value"
                :placeholder="$t('t-select-coverage-period')" />
            </v-col>
          </v-row>
        </v-card-text>
